...
const Preloader = () => {
    ...
    useEffect(() => {
        const handlePreloader = () => {
            ...
            setTimeout(() => {
                preloader.current.className = preloader.current.className.replace("block", "hidden");
    ...
    return (
        ...
        ref={preloader} 
        id="preloader" 
        className= "bg-[#060606] fixed top-0 left-0 w-[100vw] h-[100vh] opacity-100 z-[100] ease-in-out duration-[550ms] delay-[2s] block">
            <h1 
