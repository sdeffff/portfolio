...
import resume from "/resume/Maksym Pavlii.pdf";
...
const About = () => {
    ...
    return (
        <section className="w-full h-[100vh]">
            ...
            <section className="text-[#dcdde1] flex flex-col gap-5 items-start absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-3 lg:w-fit lg:px-0">
                ...
                <a href={resume} target="_blank" className="about-resume int text-2xl">Resume</a>
